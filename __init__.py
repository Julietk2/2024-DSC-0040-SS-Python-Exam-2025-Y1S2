...
from.controllers.course.course_controllers import course
from.controllers.student.student_controllers import student
from.controllers.program.program_controllers import program
